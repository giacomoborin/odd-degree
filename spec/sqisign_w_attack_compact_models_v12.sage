...
Optimization
------------
Each model optimizes B independently over

    2 <= B <= (p/2)^(1/6).

Optimization is performed in log2(B), using SciPy.
It shouldn't be seen as a theorem about the optimal B and can be further improved.
...
Run
---
    sage sqisign_w_attack_compact_models_v12.sage
"""
...
def main():
    print("## SQIsign / Wesolowski Algorithm 1 compact cost model - revision 11")
    print("")
