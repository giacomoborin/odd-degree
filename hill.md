...
The Hill estimator is designed for heavy upper tails. The standard model is
...
In the extreme value theory usually they write
instead using $$ \gamma = \frac{1}{\alpha}, $$
