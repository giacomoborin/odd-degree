...
Note that the transcripts are generated as in $\HintSim_\Sigma(1^\secp, \numOSign, \Sim)$ of \Cref{fig:hint-hvzk} and the witness $w$ is discarded.
...
the loss is a \emph{single} hint-assisted \wHVZK advantage with
